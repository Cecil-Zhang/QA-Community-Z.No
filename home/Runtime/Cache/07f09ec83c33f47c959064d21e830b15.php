...
<ul class="nav nav-tabs nav-justified" role="tablist">
  <li role="presentation" class="<?php echo ($publishDate); ?>"><a href="__URL__/browse/">按新鲜度排序</a></li>
  <li role="presentation" class="<?php echo ($agreeNum); ?>"><a href="__URL__/browse/sort/agreeNum/">按点赞数排序</a></li>
  <li role="presentation" class="<?php echo ($readNum); ?>"><a href="__URL__/browse/sort/readNum,publishDate">按热度排序</a></li>
  <li role="presentation" class="<?php echo ($answerNum); ?>"><a href="__URL__/browse/sort/answerNum">按回答数排序</a></li>
  <li role="presentation" class="<?php echo ($credit); ?>"><a href="__URL__/browse/sort/credit">按悬赏积分排序</a></li>
</ul>
</div>
</div>
<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="row personelrow">
	...
	<div class="col-lg-7">
		<h6 class="title">
		<a href="__APP__/Answer/answer/qid/<?php echo ($vo["Qid"]); ?>" class="title"><?php echo ($vo["title"]); ?></a><span class="tag"><?php echo ($vo["tags"]); ?></span>
			<div class="pull-right"><strong class="credit">悬赏:<?php echo ($vo["credit"]); ?></strong>
			<?php  if($vo['ifFixed']!="-1"){ echo '<button type="button" class="btn btn-success btn-sm" id="fix">已解决<span class="glyphicon glyphicon-ok"></span>
