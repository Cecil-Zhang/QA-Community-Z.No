...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/zno.ico">
	
    <load file="_Public_/css/style.css">
	
    <!-- Bootstrap core CSS -->
	<load file="_Public_/css/bootstrap.min.css">
	
    <!-- Custom styles for this template -->
	<load file="_Public_/css/signin.css">
	
	<!-- 包括flat ui样式 -->
	<load file="_Public_/css/flat-ui.css">
	
	<!-- 包括Font Awesome样式 -->
	<load file="_Public_/css/font-awesome.min.css">
  ...
  <div class="collapse navbar-collapse" id="navbar-collapse-01">
	...
	<ul class="nav navbar-nav navbar-right" id="personel">
			<li><img src="img/head/default.jpg" alt="头像" class="img-rounded thumbnail"></img> 
            <li class="dropdown">
...
<script src="js/bootstrap.min.js"></script>
  ...
  <load file="_Public_/js/vendor/jquery.min.js">
  <!-- 包括所有已编译的插件 -->
  <load file="_Public_/js/flat-ui.min.js">
  <script>
      $(function () {
